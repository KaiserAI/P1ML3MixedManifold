...
# NUEVO: Porcentaje de datos a usar para este experimento específico (ejemplo: 50%)
...
def run_experiment_A():
    ...
    for dataset_name in DATASETS:
        ...
        # El input_dim se extrae directamente del array cargado (esto es correcto y no redundante)
